                    ...
                    <div className="about__presentation">
                        ...
                        <div className="about__presentation__container">
                            <div className="about__presentation__text">
                                ...
                                <br />
                                <p>Faisant preuve de rigueur, étant pourvu d'un esprit curieux et ayant des dispositions pour la diplomatie, ces aptitudes me permettent de remettre mes pratiques en questions et d’enrichir constamment mes connaissances. De plus il ma toujours tenu à coeur d'échanger et de transmettre  ce savoir, afin de garantirla meilleure prise en charge possible au patient. Durant mon cursus professionnel, j'ai déjà eu la chance d’exercer des postes de référent d'équipe, notamment en endoscopie digestive mais également en tant qu'infirmier coordianteur d’une unité de chirurgie ambulatoire.  Ainsi, j'ai déjà pu épauler et guider mes consoeurs et confrères sur la voie des bonnes pratiques au quotidien. </p>
                                <br />
                                <p>Ayant déjà travaillé en tant qu’infirmier conseil chez Isis Diabete, j’ai ainsi pu acquérir une expérience certaine dans la prestation en diabétologie. Cela me permet d’être à l’aise autant dans le savoir-faire que dans le savoir-être dans ce domaine.
                                </p>
                                <br />
                                <p>Je souhaiterai faire évoluer mon exercice professionnel avec un ce nouveau challenge d'infirmier source en mettant mes connaissances techniques et mes appitudes humaines au sein de votre entreprise que j'affectionne particulièrement pour y avoir déjà exercé. En effet je suis sensible à la politique que propose Isis Diabete. Cet politique auquel j'y adhere est à mon sens gage de qualité auprès  des patients et permet un rayonnement de l'entreprise au près des prescripteurs. </p>
                                <br />
