                        ...
                        <div className="about__presentation__container">
                            <div className="about__presentation__text">
                                ...
                                <p>Depuis dix années passées dans le monde de la santé, j'ai pu acquérir une expérience technique et humaine  me permettant de m'adapter facilement aux différents modes d'exercice que peut représenter le métier d'infirmier.
                                    Ayant le contact facile et une réelle écoute active, j'ai toujours eu pour but d'être au plus haut niveau en matière de qualité dans la prise ne charge des patients.</p>
                                <br />
                                <p>Faisant preuve de rigueur, étant pourvu d'un esprit curieux et ayant des dispositions pour la diplomatie, ces aptitudes me permettent de remettre mes pratiques en questions et d’enrichir constamment mes connaissances à jour tout en ayant le même plaisir pour les partager.  A mon sens, l'échange et la transmission de savoir garantissent la meilleure prise en charge possible au patient. Durant mon cursus professionnel, j'ai déjà eu la chance d’exercer des postes de référent d'équipe, notamment en endoscopie digestive ou j'étais référent d'équipe et en tant qu'infirmier coordianteur d’une unité de chirurgie ambulatoire. Ces postes m'ont appris l'importance de la formation continue des équipes pour garantir une qualité optiamale de prise de prise en charge patient. Ainsi, j'ai déjà pu épauler et guider mes consoeurs et confrères sur la voie des bonnes pratiques au quotidien. </p>
                                <br />
                                <p>Ayant déjà travaillé en tant qu’infirmier conseil chez Isis Diabete, j’ai pu acquérir une expérience certaine en prestation diabétologique. Cela me permet d’être à l’aise autant dans le savoir-faire que dans le savoir-être dans ce domaine.</p>
                                <br />
                                <p>Je souhaiterais faire évoluer mon exercice professionnel  afin d'enrichir mes connaissances et mettre mes compétences techniques et humaines au sein de votre entreprise que j'affectionne particulièrement pour y avoir déjà exercé.</p>
                                <br />
